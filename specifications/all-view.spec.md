...
| `t` | No-op | Defer task to tomorrow (shift due date) | No-op | No-op |
| `e` | No-op | Tag task with `evening` label (hides until 17:00) | No-op | No-op |
